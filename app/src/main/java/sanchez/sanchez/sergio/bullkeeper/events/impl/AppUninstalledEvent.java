 ...
 */
public final class AppUninstalledEvent extends SupportEvent<IAppEventVisitor> {
     ...
     * @param terminal
     */
    public AppUninstalledEvent(String identity, String packageName, long firstInstallTime, long lastUpdateTime,
     ...
     * @return
     */
    public static AppUninstalledEvent fromBundle(final Bundle bundle) {
        ...
        return new AppUninstalledEvent(identity, packageName,
                firstInstallTime, lastUpdateTime, versionName,
                versionCode, appName, appRule, iconEncodedString,
                disabled, terminal);
    }
}
