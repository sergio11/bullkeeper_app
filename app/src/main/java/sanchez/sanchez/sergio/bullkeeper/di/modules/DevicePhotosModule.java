...
public class DevicePhotosModule {
    ...
    /**
     * Provide Disable Device Photo Interact
     * @return
     */
    @Provides @PerActivity
    public DisableDevicePhotoInteract provideDisableDevicePhotoInteract(
            final IThreadExecutor threadExecutor,
            final IPostExecutionThread postExecutionThread,
            final IDevicePhotosRepository devicePhotosRepository
    ){
        return new DisableDevicePhotoInteract(threadExecutor, postExecutionThread, devicePhotosRepository);
    }
