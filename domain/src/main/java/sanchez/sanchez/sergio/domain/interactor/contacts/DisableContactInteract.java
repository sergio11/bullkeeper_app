 ...
 */
public final class DisableContactInteract
        extends UseCase<String, DisableContactInteract.Params> {
     ...
     */
    public DisableContactInteract(final IThreadExecutor threadExecutor,
    ...
    protected Observable<String> buildUseCaseObservable(final Params params) {
        ...
        return contactsRepository.disableContact(params.getKid(),
