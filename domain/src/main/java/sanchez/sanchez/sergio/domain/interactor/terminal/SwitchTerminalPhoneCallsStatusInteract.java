 ...
 */
public final class SwitchTerminalPhoneCallsStatusInteract
            extends UseCase<String, SwitchTerminalPhoneCallsStatusInteract.Params> {
     ...
     */
    public SwitchTerminalPhoneCallsStatusInteract(
    ...
    protected Observable<String> buildUseCaseObservable(Params params) {
        ...
        return terminalRepository.switchTerminalPhoneCallsStatus(
