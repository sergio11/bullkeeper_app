 ...
 */
public final class AcceptSupervisedChildrenNoConfirmedInteract
    extends UseCase<String, AcceptSupervisedChildrenNoConfirmedInteract.Params> {
     ...
     */
    public AcceptSupervisedChildrenNoConfirmedInteract(final IThreadExecutor threadExecutor,
    ...
    protected Observable<String> buildUseCaseObservable(Params params) {
        ...
        return supervisedChildrenRepository.acceptSupervisedChildrenNoConfirmed(params.getKid());
