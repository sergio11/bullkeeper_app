 ...
 */
public final class SwitchSettingsScreenStatusInteract
            extends UseCase<String, SwitchSettingsScreenStatusInteract.Params> {
     ...
     */
    public SwitchSettingsScreenStatusInteract(
    ...
    protected Observable<String> buildUseCaseObservable(Params params) {
        ...
        return terminalRepository.switchSettingsScreenStatus(
