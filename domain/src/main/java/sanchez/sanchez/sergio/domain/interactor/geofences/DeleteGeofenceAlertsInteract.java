 ...
 */
public final class DeleteGeofenceAlertsInteract extends UseCase<String, DeleteGeofenceAlertsInteract.Params> {
     ...
     */
    public DeleteGeofenceAlertsInteract(
    ...
    protected Observable<String> buildUseCaseObservable(Params params) {
        ...
        return geofencesRepository.deleteGeofenceAlerts(params.getKid(), params.getId());
    }
