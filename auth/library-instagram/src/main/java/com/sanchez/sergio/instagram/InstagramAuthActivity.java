...
public class InstagramAuthActivity extends SimpleAuthActivity {
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    clientId = AppUtils.getMetaDataValue(this, getString(R.string.com_sanchez_sergio_instagramClientId));
    clientSecret = AppUtils.getMetaDataValue(this, getString(R.string.com_sanchez_sergio_instagramClientSecret));
    redirectUrl = AppUtils.getMetaDataValue(this, getString(R.string.com_sanchez_sergio_instagramRedirectUrl));
