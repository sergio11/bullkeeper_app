...
public final class TerminalDetailDTO extends TerminalDTO {
     ...
     * @param screenStatus
     */
    public TerminalDetailDTO(String identity, String appVersionName, String appVersionCode, String osVersion, String sdkVersion, String manufacturer, String marketName, String model, String codeName, String deviceName, String deviceId, boolean bedTimeEnabled, boolean lockScreenEnabled, boolean lockCameraEnabled, long totalApps, long totalSms, long totalCalls, long totalContacts, String lastTimeUsed, String screenStatus) {
        super(identity, appVersionName, appVersionCode, osVersion, sdkVersion, manufacturer, marketName, model, codeName, deviceName, deviceId, bedTimeEnabled, lockScreenEnabled, lockCameraEnabled);
